...
TrendingAll _$TrendingAllFromJson(Map<String, dynamic> json) {
  return _TrendingAll.fromJson(json);
}
...
mixin _$TrendingAll {
  ...
  @JsonKey(ignore: true)
  $TrendingAllCopyWith<TrendingAll> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $TrendingAllCopyWith<$Res> {
  factory $TrendingAllCopyWith(
          TrendingAll value, $Res Function(TrendingAll) then) =
      _$TrendingAllCopyWithImpl<$Res, TrendingAll>;
  @useResult
  $Res call(
      {String? posterPath,
      bool adult,
...
/// @nodoc
class _$TrendingAllCopyWithImpl<$Res, $Val extends TrendingAll>
    implements $TrendingAllCopyWith<$Res> {
  _$TrendingAllCopyWithImpl(this._value, this._then);
...
class _$_TrendingAll implements _TrendingAll {
  ...
  @override
  String toString() {
    return 'TrendingAll(posterPath: $posterPath, adult: $adult, overview: $overview, releaseDate: $releaseDate, genreIds: $genreIds, id: $id, originalTitle: $originalTitle, originalLanguage: $originalLanguage, title: $title, backdropPath: $backdropPath, popularity: $popularity, voteCount: $voteCount, video: $video, voteAverage: $voteAverage)';
  }
...
abstract class _TrendingAll implements TrendingAll {
  factory _TrendingAll(
      {final String? posterPath,
      ...
      required final double voteAverage}) = _$_TrendingAll;
