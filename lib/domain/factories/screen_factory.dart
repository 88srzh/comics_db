...
import 'package:comics_db_app/ui/widgets/tv_seasons/tv_seasons_list_widget.dart';
...
class ScreenFactory {
  ...
  Widget makePeopleDetailsKnownForList(int peopleId) {
    return BlocProvider(
      ...
      child: const PeopleDetailsKnownForListWidget(),
    );
  }
  ...
  Widget tvDetailsListOfEpisodes(int tvId) {
    return BlocProvider(
      ...
      child: TvDetailsSeasonDetailsListWidget(tvId: tvId),
    );
  }
