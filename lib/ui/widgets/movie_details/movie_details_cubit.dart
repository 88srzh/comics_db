...
class MovieDetailsCubitState {
  ...
  bool operator ==(Object other) =>
      identical(this, other) || other is MovieDetailsCubitState && runtimeType == other.runtimeType && localeTag == other.localeTag;
...
class MovieDetailsCubit extends Cubit<MovieDetailsCubitState> {
  ...
  MovieDetailsCubit(this.movieDetailsData, this.movieDetailsBloc, this.movieId) : super(MovieDetailsCubitState(localeTag: '')) {
    Future.microtask(
      () {
